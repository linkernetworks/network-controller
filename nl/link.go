...
// AddRouteViaInterface is a function for Adding a route via gateway
// ex: ip route add 192.0.2.0/25 dev eth0
...
// ex: ip route add 192.0.2.128/25 via 192.0.2.1 dev eth0
